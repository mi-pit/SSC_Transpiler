...
public abstract class SSCParserBase extends Parser {
    ...
    public boolean IsAlignmentSpecifier() {
        ...
        if (this.debug)
            System.out.print("IsAlignmentSpecifier " + lt1);
    ...
    public boolean IsAtomicTypeSpecifier() {
        ...
        String text = lt1.getText();
        if (this.debug)
            System.out.print("IsAtomicTypeSpecifier " + lt1);
        Symbol resolved = resolveWithOutput(lt1);
        boolean result = false;
        if (resolved == null) {
            result = false;
    ...
    public boolean IsAttributeSpecifier() {
        ...
        Token lt1 = ((CommonTokenStream) this.getInputStream()).LT(1);
        if (this.debug)
            System.out.print("IsAttributeSpecifier " + lt1);
        boolean result = lt1.getType() == SSCLexer.LeftBracket;
        if (this.debug)
            System.out.println(" " + result);
        return result;
    }
    ...
    public boolean IsEnumSpecifier() {
        ...
        Token lt1 = ((CommonTokenStream) this.getInputStream()).LT(1);
        if (this.debug)
            System.out.print("IsEnumSpecifier " + lt1);
    ...
    public boolean IsFunctionSpecifier() {
        ...
        String text = lt1.getText();
        if (this.debug)
            System.out.print("IsFunctionSpecifier " + lt1);
        Symbol resolved = resolveWithOutput(lt1);
        boolean result = false;
        if (resolved == null) {
            result = false;
        ...
        if (this.debug)
            System.out.println("IsFunctionSpecifier " + result);
        return result;
    }
    ...
    public boolean IsStatement() {
        ...
        if (this.debug)
            System.out.println("IsStatement1 " + t1);
        if (this.debug)
            System.out.println("IsStatement2 " + t2);
        if (t1.getType() == SSCLexer.Identifier && t2.getType() == SSCLexer.Colon) {
            if (this.debug)
                System.out.print("IsStatement3 true");
            return true;
        }
        boolean result = !IsDeclaration();
        if (this.debug)
            System.out.print("IsStatement " + result);
        return result;
    }
    ...
    public boolean IsStaticAssertDeclaration() {
        ...
        if (this.debug)
            System.out.print("IsStaticAssertDeclaration " + token);
        boolean result = token.getType() == SSCLexer.Static_assert;
        if (this.debug)
            System.out.println(" " + result);
        return result;
    }
    ...
    public boolean IsStorageClassSpecifier() {
        ...
        String text = lt1.getText();
        if (this.debug)
            System.out.print("IsStorageClassSpecifier " + lt1);
        Symbol resolved = resolveWithOutput(lt1);
        boolean result = false;
        if (resolved == null) {
            result = false;
    ...
    public boolean IsStructOrUnionSpecifier() {
        ...
        Token token = ((CommonTokenStream) this.getInputStream()).LT(1);
        if (this.debug)
            System.out.print("IsStructOrUnionSpecifier " + token);
    ...
    public boolean IsTypedefName() {
        ...
        String text = lt1.getText();
        if (this.debug)
            System.out.print("IsTypedefName " + lt1);
        Symbol resolved = resolveWithOutput(lt1);
        boolean result = false;
        if (resolved == null) {
            result = false;
    ...
    public boolean IsTypeofSpecifier() {
        ...
        Token token = ((CommonTokenStream) this.getInputStream()).LT(1);
        if (this.debug)
            System.out.print("IsTypeofSpecifier " + token);
        boolean result = token.getType() == SSCLexer.Typeof ||
    ...
    public boolean IsTypeQualifier() {
        ...
        String text = lt1.getText();
        if (this.debug)
            System.out.print("IsTypeQualifier " + lt1);
        Symbol resolved = resolveWithOutput(lt1);
        boolean result = false;
        if (resolved == null) {
            result = false;
    ...
    public boolean IsTypeSpecifier() {
        ...
        String text = lt1.getText();
        if (this.debug)
            System.out.print("IsTypeSpecifier " + lt1);
        Symbol resolved = resolveWithOutput(lt1);
        boolean result = false;
        if (resolved == null) {
            result = false;
    ...
    public boolean IsCast() {
        ...
        Token t2 = ((CommonTokenStream) this.getInputStream()).LT(2);
        if (this.debug)
            System.out.println("IsCast1 " + t1);
        if (this.debug)
            System.out.println("IsCast2 " + t2);
        if (t1.getType() != SSCLexer.LeftParen) {
            if (this.debug)
                System.out.print("IsCast " + result);
