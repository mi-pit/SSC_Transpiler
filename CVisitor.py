...
class CVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by CParser#superStructSpecifier.
    def visitSuperStructSpecifier(self, ctx:CParser.SuperStructSpecifierContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by CParser#superStructBody.
    def visitSuperStructBody(self, ctx:CParser.SuperStructBodyContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by CParser#superStructMember.
    def visitSuperStructMember(self, ctx:CParser.SuperStructMemberContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by CParser#superStructDeclaration.
    def visitSuperStructDeclaration(self, ctx:CParser.SuperStructDeclarationContext):
        return self.visitChildren(ctx)
